...
########
    ...
    def __init__(self, window, window_title):  
            ...
            #self.update_background_image()
                ...
                # IMAGEN BACKGROUND
            image_path = ImageTk.PhotoImage(file="background.png")
        ...
        # Crear el Label con el texto
            ...
            self.text_label = tk.Label(self.image_label, text="Bienvenido a E-Reader, aqui aparecerán las respuestas que se generen", fg="white", bg="black", font=("Arial", 8), wraplength=anchotexto, justify="left")
