    ...
    def reproducir_audio_y_guardar_audio(self,texto): 
        try:
            with BytesIO() as f:
                ...
                print("Escribiendo el archivo de audio:  -"+nombre_audio)
                tts.write_to_fp(f)
                f.seek(0)
...
## COMANDS  >>> 
            ...
            self.window.bind('2', lambda e: self.gemini_savetexto("extrae el texto que encuentres")) 
            self.window.bind('3', lambda e: self.gemini_saveaudio("extrae el texto que encuentres"))
            self.window.bind('4', lambda e: self.gemini("describe la tabla lógicamente y de forma estructuradan")) 
            self.window.bind('5', lambda e: self.gemini_savetexto("describe la tabla lógicamente y de forma estructurada")) 
            self.window.bind('6', lambda e: self.gemini_saveaudio("describe la tabla lógicamente y de forma estructurada")) 
            self.window.bind('7', lambda e: self.gemini("Describe la figura lógicamente y de forma estructurada" ))
            self.window.bind('8', lambda e: self.gemini_savetexto("Describe la figura lógicamente y de forma estructurada")) 
            self.window.bind('9', lambda e: self.gemini_saveaudio("Describe la figura lógicamente y de forma estructurada")) 
